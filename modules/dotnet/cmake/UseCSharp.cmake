...
macro( CSHARP_ADD_PROJECT type name )
  ...
  # Create whitespace separated argument lists
  ...
  set(arguments_str "/t:${type} /out:${name}.${output} /platform:${CSHARP_PLATFORM} ${CSHARP_SDK} ${refs} ${sources}")
  separate_arguments(arguments WINDOWS_COMMAND ${arguments_str})
  
  # Add custom target and command
  MESSAGE( STATUS "Adding C# ${type} ${name}: '${CSHARP_COMPILER} ${arguments_str}'" )
  add_custom_command(
    COMMENT "Compiling C# ${type} ${name}: '${CSHARP_COMPILER} ${arguments_str}'"
  ...
  foreach(ref_local ${refs_local})
    add_custom_command(
      COMMENT "Copying local reference ${ref_local} to output directory"
      TARGET ${name}
      POST_BUILD
      COMMAND ${CMAKE_COMMAND} -E copy_if_different "${ref_local}" ${CSHARP_BINARY_DIRECTORY}
      WORKING_DIRECTORY ${CSHARP_BINARY_DIRECTORY}
    )
  endforeach()
